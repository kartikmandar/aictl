"""Shutdown command for AICTL."""

import click
from aictl.services.session_service import list_sessions, delete_session


@click.command()
@click.option('--all', 'shutdown_all', is_flag=True, help='Shutdown all aictl sessions')
