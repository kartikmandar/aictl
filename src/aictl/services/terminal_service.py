...
from aictl.clients.database import (
...
from aictl.utils.terminal import generate_terminal_id, generate_session_name, generate_window_name
from aictl.models.terminal import Terminal
from aictl.constants import SESSION_PREFIX, TERMINAL_LOG_DIR
...
def create_terminal(provider: str, agent_profile: str, session_name: str = None,
                   new_session: bool = False, working_directory: str = None) -> Terminal:
