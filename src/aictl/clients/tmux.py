...
import libtmux
from aictl.constants import TMUX_HISTORY_LINES
...
class TmuxClient:
    ...
    def create_session(self, session_name: str, window_name: str, terminal_id: str, start_directory: str = None) -> str:
        """Create detached tmux session with initial window and return window name."""
        try:
            environment = os.environ.copy()
            environment['AICTL_TERMINAL_ID'] = terminal_id
    ...
    def create_window(self, session_name: str, window_name: str, terminal_id: str, start_directory: str = None) -> str:
