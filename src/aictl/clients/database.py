...
from aictl.models.inbox import MessageStatus, InboxMessage
from aictl.constants import DATABASE_URL, DB_DIR
...
class TerminalModel(Base):
    ...
    tmux_session = Column(String, nullable=False)  # "aictl-session-name"
